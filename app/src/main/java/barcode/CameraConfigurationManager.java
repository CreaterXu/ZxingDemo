...
//             logUtils.i("CameraConfigurationManager.class", "initCamera:����ͷ֧�ֵ�pictureSizes: width = "+size.width+"height = "+size.height);  
//         }  
//         for(int i=0; i<previewSizes.size(); i++){  
//             Size size = previewSizes.get(i);  
//             logUtils.i("CameraConfigurationManager.class", "initCamera:����ͷ֧�ֵ�previewSizes: width = "+size.width+"height = "+size.height);
//         } 
...
//		setDisplayOrientation(camera, 90);
	 ...
	 * (NumberFormatException nfe) { logUtils.w(CameraConfigurationManager.class, "Bad sharpness-max: " +
	 * maxSharpnessString); } }
	 * 
